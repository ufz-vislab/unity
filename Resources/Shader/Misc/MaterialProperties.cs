			...
			else
			{
				...
				switch (materials.Length)
				{
					case 1:
						...
						break;
					case 2:
						materials[0].shader = Shader.Find("UFZ/" + transparent + "-" + colorBy + "-" + lit + "-" + SideMode.Front.ToString("f"));
						materials[1].shader = Shader.Find("UFZ/" + transparent + "-" + colorBy + "-" + lit + "-" + SideMode.Back.ToString("f"));
